      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="text-background/70 leading-relaxed text-sm">
              Delivering the freshest, premium organic fruits directly from sustainable farms to your doorstep. Taste the difference of pure nature.
            </p>
          ...
          <div className="flex flex-col gap-6">
            ...
            <ul className="flex flex-col gap-3">
              {['About Us', 'Shop Fruits', 'Our Farms', 'Delivery Policy', 'Contact'].map((link) => (
                <li key={link}>
          ...
          <div className="flex flex-col gap-6">
            ...
            <ul className="flex flex-col gap-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-background/70 text-sm">123 Organic Lane, Farmville, CA 90210</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-background/70 text-sm">hello@morningfruit.com</span>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="text-background/70 text-sm">
              Subscribe to get special offers, free giveaways, and fresh deals.
            </p>
            <div className="relative mt-2">
              <input
                type="email"
                placeholder="Your email address"
                className="w-full bg-white/10 border border-white/20 rounded-full py-3.5 pl-5 pr-14 text-sm text-white placeholder:text-white/40 focus:outline-none focus:border-primary transition-colors"
              />
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-background/50 text-sm">
            © {new Date().getFullYear()} Morning Fruit. All rights reserved.
          </p>
