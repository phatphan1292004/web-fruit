import { FiHome, FiUsers, FiPackage, FiShoppingCart, FiStar, FiBarChart2, FiSettings, FiLogOut, FiMessageSquare, FiPercent } from 'react-icons/fi';
...
export const SIDEBAR_MENU: SidebarMenuItem[] = [
  ...
  { id: 'promotions', label: 'Quản lý khuyến mãi', icon: FiPercent, path: '/admin/promotions' },
