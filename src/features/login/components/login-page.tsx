      ...
      <main className="flex-1 pt-40 pb-16">
        <div className="container mx-auto px-4 md:px-8 max-w-md">
          <div className="bg-white shadow-xl rounded-3xl border border-border p-8">
            ...
            <p className="text-sm text-foreground/70 mb-6">Chào mừng bạn quay lại. Hãy đăng nhập để tiếp tục.</p>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="space-y-2">
                ...
                <input id="password" type="password" autoComplete="current-password" required value={password} onChange={(event) => setPassword(event.target.value)} className="w-full rounded-lg border border-border bg-background px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary" placeholder="Mật khẩu của bạn" />
              </div>
